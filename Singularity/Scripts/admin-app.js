...
$(function () {
    ...
    if (o.navbarMenuSlimscroll && typeof $.fn.slimscroll !== 'undefined' && $.fn.slimscroll !== null) {
...
function _init() {
    ...
    $.AdminLTE.layout = {
        ...
        fix: function () {
            ...
            if ($('body').hasClass('fixed')) {
                ...
                if (typeof controlSidebar !== 'undefined' && controlSidebar !== null) {
    ...
    $.AdminLTE.tree = function (menu) {
        ...
        $(document).on('click', menu + ' li a', function (e) {
            ...
            if (target.is('i')) { //checkElement.is('.treeview-menu')) {
                e.preventDefault();
            }
        });
    };

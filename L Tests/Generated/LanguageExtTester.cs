...
namespace L_Tests.LCore.Extensions
{
    ...
    public partial class LanguageExtTester
    {
        ...
        {
            // TODO: Implement method test LCore.Extensions.LanguageExt.FindSourceCode
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.Extensions)+ "." + nameof(LanguageExt)+ "." + nameof(LanguageExt.GatherSourceCodeMetaData) + "(MemberInfo, String[]) => CodeMetaData")]

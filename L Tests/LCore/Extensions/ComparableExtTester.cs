...
namespace L_Tests.LCore.Extensions
    {
    [Trait(Traits.TargetClass, nameof(ComparableExt))]
    public class ComparableExtTester : XUnitOutputTester
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.IsEqualTo))]
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.IsNotEqualTo))]
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.IsLessThan))]
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.IsLessThanOrEqual))]
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.IsGreaterThan))]
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.IsGreaterThanOrEqual))]
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.Max))]
        public void Max()
            {
        ...
        [Fact]
        [Trait(Traits.TargetMember, nameof(ComparableExt) + "." + nameof(ComparableExt.Min))]
        public void Min()
            {

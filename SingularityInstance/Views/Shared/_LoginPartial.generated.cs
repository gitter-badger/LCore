...
WriteLiteral("            ");
       ...
       Write(Html.ActionLink($"Hello {User.Identity.GetUserName()}!", "Index", "Manage", null, new { title = "Manage" }));
...
WriteLiteral(">\r\n        <li>");
       ...
       Write(Html.ActionLink("Register", "Register", "Account", null, new { id = "registerLink" }));
...
WriteLiteral("</li>\r\n        <li>");
       ...
       Write(Html.ActionLink("Log in", "Login", "Account", null, new { id = "loginLink" }));

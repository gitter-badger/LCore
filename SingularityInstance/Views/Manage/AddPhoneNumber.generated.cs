...
namespace ASP
{
    ...
    public partial class _Views_Manage_AddPhoneNumber_cshtml : System.Web.Mvc.WebViewPage<SingularityInstance.Models.AddPhoneNumberViewModel>
    {
...
WriteLiteral("        ");
   ...
   Write(Html.LabelFor(ViewModel => ViewModel.Number, new { @class = "col-md-2 control-label" }));
...
WriteLiteral("            ");
       ...
       Write(Html.TextBoxFor(ViewModel => ViewModel.Number, new { @class = "form-control" }));

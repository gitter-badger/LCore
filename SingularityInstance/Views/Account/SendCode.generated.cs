...
namespace ASP
{
    ...
    public partial class _Views_Account_SendCode_cshtml : System.Web.Mvc.WebViewPage<SingularityInstance.Models.SendCodeViewModel>
    {
...
WriteLiteral(".</h2>\r\n\r\n");
 ...
 using (Html.BeginForm("SendCode", "Account", new {Model.ReturnUrl }, FormMethod.Post, new { @class = "form-horizontal", role = "form" })) {

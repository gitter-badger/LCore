...
namespace ASP
{
    ...
    public partial class _Views_Account_ExternalLoginConfirmation_cshtml : System.Web.Mvc.WebViewPage<SingularityInstance.Models.ExternalLoginConfirmationViewModel>
    {
...
WriteLiteral(" account.</h3>\r\n\r\n");
 ...
 using (Html.BeginForm("ExternalLoginConfirmation", "Account", new {ViewBag.ReturnUrl }, FormMethod.Post, new { @class = "form-horizontal", role = "form" }))
{

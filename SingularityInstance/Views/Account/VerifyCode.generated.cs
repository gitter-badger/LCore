...
namespace ASP
{
    ...
    public partial class _Views_Account_VerifyCode_cshtml : System.Web.Mvc.WebViewPage<SingularityInstance.Models.VerifyCodeViewModel>
    {
...
WriteLiteral(".</h2>\r\n\r\n");
 ...
 using (Html.BeginForm("VerifyCode", "Account", new {Model.ReturnUrl }, FormMethod.Post, new { @class = "form-horizontal", role = "form" })) {

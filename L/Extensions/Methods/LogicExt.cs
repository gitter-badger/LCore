...
namespace LCore.Extensions
    ...
    public static partial class L
        ...
        public static class Logic
            ...
            /// </summary>
            [CanBeNull]
            public static Dictionary<string, CacheData> GetCacheData([CanBeNull] string Key)
                {
                return Key != null && ResultCacheData.ContainsKey(Key)
                    ? ResultCacheData[Key]
                    : null;
                }
            ...
            */
            ...
            /// </summary>
            [CodeExplodeExtensionMethod("Then", new[] {"Action1", "Action2"}, Comments.Then)] public static readonly Func<Action, Action, Action> Then = (Action1, Action2) =>
                {
                return () =>
                    {
                    Action1();
            ...
            /// <param name="In"></param>
            /// <returns></returns>
            public static Func<U> Return<U>([CanBeNull]U In)
                {
                return () => In;
                }

...
namespace LCore.Extensions
    ...
    public static class DictionaryExt
        ...
        public static List<Tuple<T1, T2>> Flatten<T1, T2>([CanBeNull] this Dictionary<T1, T2> In)
            ...
            In?.Each(KeyValue => { Out.Add(new Tuple<T1, T2>(KeyValue.Key, KeyValue.Value)); });
        ...
        public static List<Tuple<T1, T2>> Flatten<T1, T2>([CanBeNull] this Dictionary<T1, IEnumerable<T2>> In)
            ...
            In?.Each(KeyValue => { KeyValue.Value.Each(Value => { Out.Add(new Tuple<T1, T2>(KeyValue.Key, Value)); }); });
        ...
        public static List<Tuple<T1, T2, T3>> Flatten<T1, T2, T3>([CanBeNull] this Dictionary<T1, Dictionary<T2, T3>> In)
            ...
            In?.Each(KeyValue => { KeyValue.Value.Each(KeyValue2 => { Out.Add(new Tuple<T1, T2, T3>(KeyValue.Key, KeyValue2.Key, KeyValue2.Value)); }); });
        ...
        public static List<Tuple<T1, T2, T3, T4>> Flatten<T1, T2, T3, T4>([CanBeNull] this Dictionary<T1, Dictionary<T2, Dictionary<T3, T4>>> In)
            ...
            In?.Each(KeyValue => { KeyValue.Value.Each(KeyValue2 => { KeyValue2.Value.Each(KeyValue3 => { Out.Add(new Tuple<T1, T2, T3, T4>(KeyValue.Key, KeyValue2.Key, KeyValue3.Key, KeyValue3.Value)); }); }); });
        ...
        public static List<Tuple<T1, T2, T3, T4>> Flatten<T1, T2, T3, T4>([CanBeNull] this Dictionary<T1, Dictionary<T2, Dictionary<T3, IEnumerable<T4>>>> In)
            ...
            In?.Each(KeyValue => { KeyValue.Value.Each(KeyValue2 => { KeyValue2.Value.Each(KeyValue3 => { KeyValue3.Value.Each(Value => Out.Add(new Tuple<T1, T2, T3, T4>(KeyValue.Key, KeyValue2.Key, KeyValue3.Key, Value))); }); }); });
        ...
        public static List<Tuple<T1, T2, T3, T4, T5>> Flatten<T1, T2, T3, T4, T5>([CanBeNull] this Dictionary<T1, Dictionary<T2, Dictionary<T3, Dictionary<T4, T5>>>> In)
            ...
            In?.Each(KeyValue => { KeyValue.Value.Each(KeyValue2 => { KeyValue2.Value.Each(KeyValue3 => { KeyValue3.Value.Each(KeyValue4 => { Out.Add(new Tuple<T1, T2, T3, T4, T5>(KeyValue.Key, KeyValue2.Key, KeyValue3.Key, KeyValue4.Key, KeyValue4.Value)); }); }); }); });
        ...
        public static List<Tuple<T1, T2, T3, T4, T5>> Flatten<T1, T2, T3, T4, T5>([CanBeNull] this Dictionary<T1, Dictionary<T2, Dictionary<T3, Dictionary<T4, IEnumerable<T5>>>>> In)
            ...
            In?.Each(KeyValue => { KeyValue.Value.Each(KeyValue2 => { KeyValue2.Value.Each(KeyValue3 => { KeyValue3.Value.Each(KeyValue4 => { KeyValue4.Value.Each(Value => Out.Add(new Tuple<T1, T2, T3, T4, T5>(KeyValue.Key, KeyValue2.Key, KeyValue3.Key, KeyValue4.Key, Value))); }); }); }); });
        ...
        public static List<Tuple<T1, T2, T3, T4, T5, T6, T7>> Flatten<T1, T2, T3, T4, T5, T6, T7>([CanBeNull] this Dictionary<T1, Dictionary<T2, Dictionary<T3, Dictionary<T4, Dictionary<T5, Dictionary<T6, IEnumerable<T7>>>>>>> In)
            ...
            In?.Each(KeyValue => { KeyValue.Value.Each(KeyValue2 => { KeyValue2.Value.Each(KeyValue3 => { KeyValue3.Value.Each(KeyValue4 => { KeyValue4.Value.Each(KeyValue5 => { KeyValue5.Value.Each(KeyValue6 => { KeyValue6.Value.Each(Value => Out.Add(new Tuple<T1, T2, T3, T4, T5, T6, T7>(KeyValue.Key, KeyValue2.Key, KeyValue3.Key, KeyValue4.Key, KeyValue5.Key, KeyValue6.Key, Value))); }); }); }); }); }); });

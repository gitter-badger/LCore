...
namespace LCore.Extensions
    ...
    public static class ObjectExt
        ...
        /// <summary>
        /// Returns a <see cref="Delta"/>, between two objects of the same types.
        /// Only the changes in property values are tracked.
        /// </summary>
        public static Delta GetDelta<T>(this T Object1, T Object2)
            {
            return new Delta(Object1, Object2);
            }
...
namespace LCore.Extensions.Optional
    ...
    public static class ObjectExt
        ...
        public static Func<T> FN_Func<T>([CanBeNull] this T In)
            {
        ...
        public static Func<T, bool> FN_If<T>([CanBeNull] this T In)
            {
        ...
        public static bool SafeEquals([CanBeNull] this object In, [CanBeNull] object Obj)
            {

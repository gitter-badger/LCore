...
namespace LCore
{
    ...
    public static class ListExt
    {
        ...
        public static List<T> Named<T>(this IEnumerable<T> In, String Name) where T : INamed
        {
            return In.List<T>().Select((o) => { return o != null && o.Name == Name; });
        }
        public static T[] Named<T>(this T[] In, String Name) where T : INamed
        {
            return In.Select((o) => { return o != null && o.Name == Name; });
        }
        public static List<T> Named<T>(this List<T> In, String Name) where T : INamed
        {
            return In.Select((o) => { return o != null && o.Name == Name; });
        }

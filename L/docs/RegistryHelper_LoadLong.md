...
###### public <a href="https://msdn.microsoft.com/en-us/library/b3h38hb0.aspx" alt="" target="_blank">Nullable</a>&lt;[Int64](https://msdn.microsoft.com/en-us/library/system.int64.aspx)&gt; LoadLong([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Name);

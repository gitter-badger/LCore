...
###### public static <a href="https://msdn.microsoft.com/en-us/library/bb534647.aspx" alt="" target="_blank">Func</a>&lt;[Action](https://msdn.microsoft.com/en-us/library/system.action.aspx), [Int32](https://msdn.microsoft.com/en-us/library/system.int32.aspx), [Action](https://msdn.microsoft.com/en-us/library/system.action.aspx)&gt; L_Repeat_int();

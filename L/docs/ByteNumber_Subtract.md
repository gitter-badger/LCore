...
###### public [Byte](https://msdn.microsoft.com/en-us/library/system.byte.aspx) Subtract([Byte](https://msdn.microsoft.com/en-us/library/system.byte.aspx) Number1, [Byte](https://msdn.microsoft.com/en-us/library/system.byte.aspx) Number2);

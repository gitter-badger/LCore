...
###### public static [Byte](https://msdn.microsoft.com/en-us/library/system.byte.aspx)[] GetStringHash([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) In);

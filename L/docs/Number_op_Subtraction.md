...
###### public static [Number](Number.md) op_Subtraction([Number](Number.md) Number1, [IConvertible](https://msdn.microsoft.com/en-us/library/system.iconvertible.aspx) Number2);

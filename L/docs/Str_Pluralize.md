...
###### public static [String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Pluralize([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Str, [Int32](https://msdn.microsoft.com/en-us/library/system.int32.aspx) Count);

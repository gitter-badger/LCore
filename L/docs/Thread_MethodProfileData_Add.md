...
###### public static [void](https://msdn.microsoft.com/en-us/library/system.void.aspx) MethodProfileData_Add([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Method, **[MethodProfileData](MethodProfileData.md)** Profile);

...
###### public static <a href="https://msdn.microsoft.com/en-us/library/b3h38hb0.aspx" alt="" target="_blank">Nullable</a>&lt;[UInt32](https://msdn.microsoft.com/en-us/library/system.uint32.aspx)&gt; FindSourceCodeLineNumber([MemberInfo](https://msdn.microsoft.com/en-us/library/system.reflection.memberinfo.aspx) Member);

...
###### public [UInt64](https://msdn.microsoft.com/en-us/library/system.uint64.aspx) Subtract([UInt64](https://msdn.microsoft.com/en-us/library/system.uint64.aspx) Number1, [UInt64](https://msdn.microsoft.com/en-us/library/system.uint64.aspx) Number2);

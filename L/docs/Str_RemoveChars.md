...
###### public static [String](https://msdn.microsoft.com/en-us/library/system.string.aspx) RemoveChars([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Str, [Char](https://msdn.microsoft.com/en-us/library/system.char.aspx)[] Chars);

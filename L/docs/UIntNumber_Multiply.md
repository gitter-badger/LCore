...
###### public [UInt32](https://msdn.microsoft.com/en-us/library/system.uint32.aspx) Multiply([UInt32](https://msdn.microsoft.com/en-us/library/system.uint32.aspx) Number1, [UInt32](https://msdn.microsoft.com/en-us/library/system.uint32.aspx) Number2);

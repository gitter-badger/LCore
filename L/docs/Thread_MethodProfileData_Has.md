...
###### public static [Boolean](https://msdn.microsoft.com/en-us/library/system.boolean.aspx) MethodProfileData_Has([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Method);

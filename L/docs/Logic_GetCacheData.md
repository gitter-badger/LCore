...
###### public static <a href="https://msdn.microsoft.com/en-us/library/xfhwa508.aspx" alt="" target="_blank">Dictionary</a>&lt;[String](https://msdn.microsoft.com/en-us/library/system.string.aspx), **[CacheData](CacheData.md)**&gt; GetCacheData([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Key);

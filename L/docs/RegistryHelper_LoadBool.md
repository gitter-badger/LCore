...
###### public <a href="https://msdn.microsoft.com/en-us/library/b3h38hb0.aspx" alt="" target="_blank">Nullable</a>&lt;[Boolean](https://msdn.microsoft.com/en-us/library/system.boolean.aspx)&gt; LoadBool([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Name);

...
###### public static [Boolean](https://msdn.microsoft.com/en-us/library/system.boolean.aspx) CanConvertToString([IConvertible](https://msdn.microsoft.com/en-us/library/system.iconvertible.aspx) In);

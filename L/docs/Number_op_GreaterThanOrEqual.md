...
###### public static [Boolean](https://msdn.microsoft.com/en-us/library/system.boolean.aspx) op_GreaterThanOrEqual([Number](Number.md) Number1, [IComparable](https://msdn.microsoft.com/en-us/library/system.icomparable.aspx) Number2);

...
###### public <a href="https://msdn.microsoft.com/en-us/library/b3h38hb0.aspx" alt="" target="_blank">Nullable</a>&lt;[Single](https://msdn.microsoft.com/en-us/library/system.single.aspx)&gt; LoadFloat([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Name);

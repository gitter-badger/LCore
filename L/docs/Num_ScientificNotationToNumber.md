...
###### public static [String](https://msdn.microsoft.com/en-us/library/system.string.aspx) ScientificNotationToNumber([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) In);

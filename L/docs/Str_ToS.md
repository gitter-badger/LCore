...
###### public static [String](https://msdn.microsoft.com/en-us/library/system.string.aspx) ToS([Object](https://msdn.microsoft.com/en-us/library/system.object.aspx) Obj);

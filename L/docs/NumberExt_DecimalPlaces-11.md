...
##### public static <a href="https://msdn.microsoft.com/en-us/library/system.uint16.aspx" alt="">UInt16</a> DecimalPlaces(<a href="https://msdn.microsoft.com/en-us/library/system.single.aspx" alt="">Single</a> Float);
...
:---  | :---  | :---  | :--- 
Float | No | [Single](https://msdn.microsoft.com/en-us/library/system.single.aspx) | 

...
##### public static <a href="https://msdn.microsoft.com/en-us/library/dd235351.aspx" alt="" target="_blank">Action</a>&lt;T1, T2, T3, T4, T5, T6, T7, T8&gt; Action(<a href="https://msdn.microsoft.com/en-us/library/dd235351.aspx" alt="" target="_blank">Action</a>&lt;T1, T2, T3, T4, T5, T6, T7, T8&gt; In);

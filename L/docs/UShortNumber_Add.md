...
###### public [UInt16](https://msdn.microsoft.com/en-us/library/system.uint16.aspx) Add([UInt16](https://msdn.microsoft.com/en-us/library/system.uint16.aspx) Number1, [UInt16](https://msdn.microsoft.com/en-us/library/system.uint16.aspx) Number2);

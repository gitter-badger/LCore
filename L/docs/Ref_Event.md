...
###### public static [EventInfo](https://msdn.microsoft.com/en-us/library/system.reflection.eventinfo.aspx) Event([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) EventName);

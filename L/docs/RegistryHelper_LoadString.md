...
###### public [String](https://msdn.microsoft.com/en-us/library/system.string.aspx) LoadString([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Name);

...
###### public static [String](https://msdn.microsoft.com/en-us/library/system.string.aspx) ConvertToString([IConvertible](https://msdn.microsoft.com/en-us/library/system.iconvertible.aspx) In);

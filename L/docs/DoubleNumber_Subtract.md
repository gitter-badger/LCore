...
###### public [Double](https://msdn.microsoft.com/en-us/library/system.double.aspx) Subtract([Double](https://msdn.microsoft.com/en-us/library/system.double.aspx) Number1, [Double](https://msdn.microsoft.com/en-us/library/system.double.aspx) Number2);

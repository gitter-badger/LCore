...
###### public static [Byte](https://msdn.microsoft.com/en-us/library/system.byte.aspx)[] ReadAllBytes([Stream](https://msdn.microsoft.com/en-us/library/system.io.stream.aspx) Input);

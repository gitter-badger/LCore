...
###### public **[Number](Number%601.md)**&lt;[Byte](https://msdn.microsoft.com/en-us/library/system.byte.aspx)&gt; New([Byte](https://msdn.microsoft.com/en-us/library/system.byte.aspx) In);
...
![UnitTested No](http://b.repl.ca/v1/UnitTested-No-lightgrey.png "") ![AttributeTests 0](http://b.repl.ca/v1/AttributeTests-0-lightgrey.png "") [![Assertions 0](http://b.repl.ca/v1/Assertions-0-lightgrey.png "")](../Numbers/ByteNumber.cs)

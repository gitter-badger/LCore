...
###### public [SByte](https://msdn.microsoft.com/en-us/library/system.sbyte.aspx) Subtract([SByte](https://msdn.microsoft.com/en-us/library/system.sbyte.aspx) Number1, [SByte](https://msdn.microsoft.com/en-us/library/system.sbyte.aspx) Number2);

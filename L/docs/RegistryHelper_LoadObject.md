...
###### public [Object](https://msdn.microsoft.com/en-us/library/system.object.aspx) LoadObject([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Name);

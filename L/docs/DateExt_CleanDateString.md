...
###### public static [String](https://msdn.microsoft.com/en-us/library/system.string.aspx) CleanDateString([DateTime](https://msdn.microsoft.com/en-us/library/system.datetime.aspx) In);

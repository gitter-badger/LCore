...
###### public **[Number](Number%601.md)**&lt;[UInt32](https://msdn.microsoft.com/en-us/library/system.uint32.aspx)&gt; New([UInt32](https://msdn.microsoft.com/en-us/library/system.uint32.aspx) In);

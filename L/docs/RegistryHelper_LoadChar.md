...
###### public <a href="https://msdn.microsoft.com/en-us/library/b3h38hb0.aspx" alt="" target="_blank">Nullable</a>&lt;[Char](https://msdn.microsoft.com/en-us/library/system.char.aspx)&gt; LoadChar([String](https://msdn.microsoft.com/en-us/library/system.string.aspx) Name);

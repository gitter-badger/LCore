...
###### public static [Boolean](https://msdn.microsoft.com/en-us/library/system.boolean.aspx) IsFuture([DateTime](https://msdn.microsoft.com/en-us/library/system.datetime.aspx) In);

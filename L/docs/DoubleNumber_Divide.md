...
###### public [Object](https://msdn.microsoft.com/en-us/library/system.object.aspx) Divide([Double](https://msdn.microsoft.com/en-us/library/system.double.aspx) Number1, [Double](https://msdn.microsoft.com/en-us/library/system.double.aspx) Number2);

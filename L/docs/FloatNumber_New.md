...
###### public [Number](Number%601.md)&lt;[Single](https://msdn.microsoft.com/en-us/library/system.single.aspx)&gt; New([Single](https://msdn.microsoft.com/en-us/library/system.single.aspx) In);

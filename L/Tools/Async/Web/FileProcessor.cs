...
namespace LCore
    ...
    public class FileProcessor : IDisposable
        ...
        public string _fullPath
            ...
            get
                {
                return L.CombinePaths(this._currentFilePath, this._currentFileName);
                }
            }
        /// <summary>
            ...
            if (_startFound)
                ...
                if (writeBytes > 0)
                    ...
                    if (_fileStream == null)
                        ...
                        _fileStream = new FileStream(L.CombinePaths(_currentFilePath, _currentFileName), FileMode.OpenOrCreate);
        ...
        public void CloseStreams()
            ...
            if (_fileStream != null)
                ...
                _finishedFiles.Add(L.CombinePaths(this._currentFilePath, _currentFileName));

...
LUnit has Autogenerated 7 Classes and 55 Methods:
*/
...
namespace LUnit_Tests.LCore.LUnit
{
    ...
    public partial class TestExtTester : XUnitOutputTester, IDisposable
    {
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LUnit)+ "." + nameof(TestExt)+ "." + nameof(TestExt.GetTestData) + "(Type, IEnumerable`1<Assembly>) => TypeTests")]

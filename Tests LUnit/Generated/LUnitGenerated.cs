...
LUnit has Autogenerated 7 Classes and 38 Methods:
*/
...
namespace LUnit_Tests.LCore.LUnit
{
    ...
    {
        public TypeCoverageTester( ITestOutputHelper Output) : base(Output) { }

        public void Dispose() { }

        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LUnit)+ "." + nameof(TypeCoverage)+ "." + nameof(TypeCoverage.GetTestStub) + "() => String[]")]
    ...
    {
        public MethodCoverageTester( ITestOutputHelper Output) : base(Output) { }

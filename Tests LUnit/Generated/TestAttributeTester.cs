...
namespace LUnit_Tests.LCore.LUnit
    ...
    public partial class TestAttributeTester : XUnitOutputTester
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TestAttribute) + "." + nameof(TestAttribute.RunTest))]
        public void RunTest()
            {
        ...
        [Fact]
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TestAttribute) + "." + nameof(TestAttribute.GenericTypes))]

...
namespace LUnit_Tests.LCore.LUnit
    ...
    public partial class MultiTestReporterTester : XUnitOutputTester
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure01))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure02))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure03))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure04))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure05))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure06))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure07))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure08))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure09))]
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(MultiTestReporter) + "." +
            nameof(MultiTestReporter.TestFailure10))]

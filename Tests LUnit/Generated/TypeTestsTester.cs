...
namespace LUnit_Tests.LCore.LUnit
    ...
    public partial class TypeTestsTester : XUnitOutputTester
        ...
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TypeTests) + "." + nameof(TypeTests.TestAttributes))]
        ...
        [Fact]
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TypeTests) + "." + nameof(TypeTests.CoveragePercent))]
        ...
        [Fact]
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TypeTests) + "." + nameof(TypeTests.TestsPresent))]
        ...
        [Fact]
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TypeTests) + "." + nameof(TypeTests.UnitTestCount))]
        ...
        [Fact]
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TypeTests) + "." + nameof(TypeTests.TestsMissing))]
        ...
        [Fact]
        [Trait(Traits.TargetMember,
            nameof(LCore) + "." + nameof(global::LCore.LUnit) + "." + nameof(TypeTests) + "." + nameof(TypeTests.MembersPresent))]

...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams
    ...
    public class InflaterInputStream : Stream
        ...
        public InflaterInputStream(Stream baseInputStream)
            : this(baseInputStream, new Inflater())
            {
            }
        ...
        /// </param>
        public InflaterInputStream(Stream baseInputStream, Inflater inflater, int bufferSize = 4096)
            {
        ...
        /// </summary>
        public override long Length => this.inputBuffer.RawLength;

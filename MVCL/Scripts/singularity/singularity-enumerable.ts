...
function EnumerableSortBy<T>(arg?: string | string[]| ((item: T) => number)): void {
...
function EnumerableQuickSort(left: number = 0, right: number = (this.length - 1), sortWith?: any[][]): any[]| any[][] {

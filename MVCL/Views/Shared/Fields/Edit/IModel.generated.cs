...
namespace ASP
{
    ...
    public partial class _Views_Shared_Fields_Edit_IModel_cshtml : System.Web.Mvc.WebViewPage<IViewField>
    {
        public _Views_Shared_Fields_Edit_IModel_cshtml()
        {
        }
...
WriteLiteral("\r\n\r\n");
            ...
            #line 26 "..\..\Views\Shared\Fields\Edit\IModel.cshtml"
 if (SubModel != null)
    {
    }
else
    ...
    List<SelectListItem> Items = Model.GetRelationItems(Model.Meta.ModelType, SubModel);
            ...
            #line 33 "..\..\Views\Shared\Fields\Edit\IModel.cshtml"

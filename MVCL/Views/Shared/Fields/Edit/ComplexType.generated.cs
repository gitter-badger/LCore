...
WriteLiteral("\r\n");
            ...
            #line 25 "..\..\Views\Shared\Fields\Edit\ComplexType.cshtml"
 if (Model.PropertyData != null)
    {
    foreach (System.Web.ModelBinding.ModelMetadata SubMeta in Model.Meta.ModelType.Meta().Properties)
        {
        ViewField Field = new ViewField(Context, SubMeta.ModelType, Model.PropertyName + "." + SubMeta.PropertyName, (IModel)Model.PropertyData, Model.ViewTypes);
            ...
            #line 31 "..\..\Views\Shared\Fields\Edit\ComplexType.cshtml"

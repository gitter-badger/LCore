...
WriteLiteral("\r\n");
    ...
    List<MVCL.Models.FileUpload> CurrentFiles = new List<MVCL.Models.FileUpload>();

    IFileUpload Attr = Model.Meta.GetAttribute<IFileUpload>();

    if (Context.ContextTypes.Has(typeof(MVCL.Models.FileUpload)))
    {
        ...
        CurrentFiles = Context.GetDBSet<MVCL.Models.FileUpload>().Where(
            f => f.Active == true &&
...
WriteLiteral("\r\n");
            ...
            #line 43 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
WriteLiteral("\').click(function () {\r\n\r\n                        $(\'.file-upload-error-no-file-");
            ...
            #line 57 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                 Write(Model.PropertyName);
...
WriteLiteral("\').hide();\r\n\r\n                        var fileName = $(\'#file-upload-");
            ...
            #line 59 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                  Write(Model.PropertyName);
...
" $(\'.file-upload-error-no-file-");
            ...
            #line 62 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                     Write(Model.PropertyName);
...
WriteLiteral(";\r\n\r\n                        $(\'.file-upload-error-incorrect-type-");
            ...
            #line 70 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                         Write(Model.PropertyName);
...
WriteLiteral("\')[0].files[0].size;\r\n\r\n                        $(\'.file-upload-error-too-small-");
            ...
            #line 95 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                    Write(Model.PropertyName);
...
WriteLiteral("\').hide();\r\n                        $(\'.file-upload-error-too-large-");
            ...
            #line 96 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                    Write(Model.PropertyName);
...
"        if (size < ");
            ...
            #line 100 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
"ror-too-small-");
            ...
            #line 102 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                        Write(Model.PropertyName);
...
"                     if (size > ");
            ...
            #line 106 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
"       }\r\n\r\n\r\n\r\n                        $.ajax({\r\n                url: \'/");
            ...
            #line 116 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
WriteLiteral("&RelationType=");
            ...
            #line 116 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                                                                      Write(Model.ModelData.TrueModelType().Name);
...
WriteLiteral("\" />\r\n\r\n            <div class=\"file-upload-error-incorrect-type-");
            ...
            #line 135 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                    Write(Model.PropertyName);
...
WriteLiteral(" error\" style=\"display:none;\">\r\n                File types allowed: ");
            ...
            #line 136 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
WriteLiteral("\r\n            </div>\r\n\r\n            <div class=\"file-upload-error-too-large-");
            ...
            #line 139 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                               Write(Model.PropertyName);
...
"");
            ...
            #line 140 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
WriteLiteral("</b>\r\n            </div>\r\n\r\n            <div class=\"file-upload-error-too-small-");
            ...
            #line 143 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                               Write(Model.PropertyName);
...
WriteLiteral(" error\" style=\"display:none;\">\r\n                Upload must be at least <b>");
            ...
            #line 144 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
WriteLiteral("</b>\r\n            </div>\r\n\r\n            <div class=\"file-upload-error-no-file-");
            ...
            #line 147 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                             Write(Model.PropertyName);
...
"ile-upload-button-");
            ...
            #line 155 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                           Write(Model.PropertyName);
...
"</div>\r\n        </div>\r\n");
            ...
            #line 160 "..\..\Views\Shared\Fields\FileUpload.cshtml"
    }
}
...
WriteLiteral("\r\n");
            ...
            #line 169 "..\..\Views\Shared\Fields\FileUpload.cshtml"
 if (Model.ViewTypes.Has(ControllerHelper.ViewType.Edit) ||
    Model.ViewTypes.Has(ControllerHelper.ViewType.Display))
{
    foreach (MVCL.Models.FileUpload File in CurrentFiles)
    {
...
"con\">\r\n                <a href=\"");
            ...
            #line 184 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                    Write(Url.Action("DownloadFile", Html.ControllerName(), new { FileID = File.FileUploadID }));
...
"Size:\r\n                ");
            ...
            #line 197 "..\..\Views\Shared\Fields\FileUpload.cshtml"
...
WriteLiteral("                <a class=\"btn btn-default\" id=\"file-upload-button-");
            ...
            #line 202 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                                                             Write(Model.PropertyName);
...
WriteLiteral("\"\r\n                   href=\"");
            ...
            #line 203 "..\..\Views\Shared\Fields\FileUpload.cshtml"
                    Write(Url.Action("DeleteFile", Html.ControllerName(), new { id = File.FileUploadID, ReturnURL = Request.Url.AbsoluteUri }));
...
WriteLiteral("        </div>\r\n");
            ...
            #line 209 "..\..\Views\Shared\Fields\FileUpload.cshtml"
    }
}
